...
public class ContactService {
    ...
    public void delete(Long deleteId) {
        ...
        //해당 아이디 존재 확인
        boolean existsID = reporitory.findById(deleteId);
        //있다면 삭제 요청
        if (existsID){
            //존재하는 경우 -> 삭제 요청
            reporitory.deleteById(deleteId);
    ...
    public void update(Long updateId, String updatePhone) {
        ...
        boolean existsID = reporitory.findById(updateId);
        //있다면 삭제 요청
        if (existsID){
            //존재하는 경우 -> 수정 요청
            reporitory.updateById(updateId, updatePhone);
